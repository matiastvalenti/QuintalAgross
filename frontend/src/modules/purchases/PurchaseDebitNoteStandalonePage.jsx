/**
 * PurchaseDebitNoteStandalonePage.jsx
 *
 * Página standalone para Nueva Nota de Débito de Compra / Editar Nota de Débito de Compra.
 */
...
export default function PurchaseDebitNoteStandalonePage() {
    ...
    <StandaloneGuard>
      <div style={{ width: "100vw", height: "100vh", overflow: "hidden", backgroundColor: "var(--bg-primary)" }}>
        <PurchaseInvoiceForm
          ...
          isStandalone={true}
          initialDocType="PURCHASE_DEBIT_NOTE"
        />
      </div>
    </StandaloneGuard>
  );
